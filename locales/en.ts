...
historyPage: {
  ...
  cms: {
    ...
    documentsMenuManager: {
      ...
      description: 'Manage navigation menu items for the Documents section.',
      addMenuItem: 'Add Menu Item',
      addNewItem: 'Add New Menu Item',
      titlePlaceholder: 'Menu item title',
      selectDocument: 'Select PDF Document',
    ...
    projectsMenuManager: {
      title: 'Projects Menu Manager',
      description: 'Manage navigation menu items for the Projects section.',
      addMenuItem: 'Add Menu Item',
      addNewItem: 'Add New Menu Item',
      titlePlaceholder: 'Menu item title',
      fileType: 'File Type',
